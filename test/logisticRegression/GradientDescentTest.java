...
public class GradientDescentTest {
    ...
    private static boolean compare(Matrix theta, Matrix x, Matrix y, double lambda, Matrix gradient, double cost) {
        ...
        LogisticRegressionCost logisticRegressionCost = LogisticRegressionCost.create(theta, x, y, lambda);

        boolean equals1 = logisticRegressionCost.getGradient().equals(gradient);
